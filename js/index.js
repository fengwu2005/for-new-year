  ...
  init: function (start) {
    ...
    if (start != 0){
      ...
      if (i !== -1) {
        ...
        S.UI.simulate('|#countdown 5||新年快乐！|身体健康！|万事如意！|小孩好好学习|大人好好工作|老人好好歇着| ');
      }
...
S.Dot = function (x, y) {
  ...
  this.c = new S.Color(300,223,0, this.p.a);
  ...
  return {
    imageFile: function (url, callback) {
      ...
      image.onerror = function () {
        //callback(S.ShapeBuilder.letter('woc'));
        
        callback(S.ShapeBuilder.letter('click'));
      }
